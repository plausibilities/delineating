...
class Models:
    ...
    def __draw(self, model: pm.Model, name: str) -> bool:
        """
        ...
        diagram.graph_attr.update(size="5.7,5.9")
    ...
    def exc(self, model: pm.Model, name: str = 'model.gv') -> None:
        """
        ...
        drawn = self.__draw(model=model, name=name)
